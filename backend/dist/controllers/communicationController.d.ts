...
export declare const getInternalMessageById: (req: Request, res: Response) => Promise<any>;
export declare const createInternalMessage: (req: Request, res: Response) => Promise<void>;
export declare const updateInternalMessage: (req: Request, res: Response) => Promise<any>;
export declare const deleteInternalMessage: (req: Request, res: Response) => Promise<any>;
...
declare const _default: {
    ...
    getInternalMessageById: (req: Request, res: Response) => Promise<any>;
    createInternalMessage: (req: Request, res: Response) => Promise<void>;
    updateInternalMessage: (req: Request, res: Response) => Promise<any>;
    deleteInternalMessage: (req: Request, res: Response) => Promise<any>;
