...
export declare const verify2FA: (req: Request, res: Response) => Promise<any>;
export declare const disable2FA: (req: Request, res: Response) => Promise<any>;
...
export declare const verifyBackupCode: (req: Request, res: Response) => Promise<any>;
