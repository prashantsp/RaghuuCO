...
exports.createPerformanceIndexes = createPerformanceIndexes;
exports.createFulltextIndexes = createFulltextIndexes;
exports.createOptimizationFunctions = createOptimizationFunctions;
...
async function createPerformanceIndexes() {
    try {
        logger_1.logger.info('Creating performance indexes...');
        for (const indexQuery of PERFORMANCE_INDEXES) {
            await db.query(indexQuery);
        }
        logger_1.logger.info('Performance indexes created successfully');
    }
    catch (error) {
        logger_1.logger.error('Error creating performance indexes:', error);
        throw error;
    }
}
async function createFulltextIndexes() {
    try {
        logger_1.logger.info('Creating full-text search indexes...');
        for (const indexQuery of FULLTEXT_INDEXES) {
            await db.query(indexQuery);
        }
        logger_1.logger.info('Full-text search indexes created successfully');
    }
    catch (error) {
        logger_1.logger.error('Error creating full-text search indexes:', error);
        throw error;
    }
}
async function createOptimizationFunctions() {
    try {
        logger_1.logger.info('Creating optimization functions...');
        for (const functionQuery of OPTIMIZATION_FUNCTIONS) {
            await db.query(functionQuery);
        }
        logger_1.logger.info('Optimization functions created successfully');
    }
    catch (error) {
        logger_1.logger.error('Error creating optimization functions:', error);
        throw error;
    }
}
async function optimizeDatabase() {
    try {
        logger_1.logger.info('Running database optimization...');
        ...
        logger_1.logger.error('Error optimizing database:', error);
        throw error;
    }
}
async function analyzeQueryPerformance() {
    try {
        logger_1.logger.info('Analyzing query performance...');
      ...
      LIMIT 20`
        ...
        logger_1.logger.error('Error analyzing query performance:', error);
        throw error;
    }
}
