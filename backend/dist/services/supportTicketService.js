...
class SupportTicketService {
    ...
    async getAllTickets(userId, filters) {
        try {
            if (!(0, roleAccess_1.hasPermission)(roleAccess_1.UserRole.SUPER_ADMIN, 'support:read_all')) {
    ...
    async assignTicket(ticketId, assignedTo, userId) {
        try {
            ...
            if (!(0, roleAccess_1.hasPermission)(roleAccess_1.UserRole.SUPER_ADMIN, 'support:assign')) {
    ...
    async getTicketStatistics(userId, filters) {
        try {
            if (!(0, roleAccess_1.hasPermission)(roleAccess_1.UserRole.SUPER_ADMIN, 'support:view_stats')) {
    ...
    canUserAccessTicket(ticket, userId) {
        return ticket.userId === userId ||
            ...
            (0, roleAccess_1.hasPermission)(roleAccess_1.UserRole.SUPER_ADMIN, 'support:read_all');
    }
    canUserUpdateTicket(ticket, userId) {
        return ticket.assignedTo === userId ||
            (0, roleAccess_1.hasPermission)(roleAccess_1.UserRole.SUPER_ADMIN, 'support:update');
    }
